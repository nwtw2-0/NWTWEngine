...
public class XP {
    ...
    public static int getExp(Player player) {
        return getExpFromLevel(player.getExperienceLevel())
                + Math.round(getExpToNext(player.getExperienceLevel()) * player.getExperience());
    }
    ...
    public static void changeExp(Player player, int exp) {
        ...
        player.setExperience((int) (levelAndExp - level),level);
    }
}
