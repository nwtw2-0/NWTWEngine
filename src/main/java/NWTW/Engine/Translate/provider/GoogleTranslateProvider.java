...
import NWTW.Engine.Translate.Network;
...
public class GoogleTranslateProvider implements TranslateProvider {
    ...
    public String translate(@NotNull String sourceLanguage, @NotNull String targetLanguage, @NotNull String text) {
        try {
            ...
            List<List> list = (List) ((List) NWTWEngine.getPlugin().getGson().fromJson(result, new TypeToken<List>() {}.getType())).get(0);
            ...
            NWTWEngine.getPlugin().getLogger().error(e.getMessage(), e);
        }
        return text;
    }
